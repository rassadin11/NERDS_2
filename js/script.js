...
let slider = document.querySelector('.filter');
...
let priceStart = document.getElementById('input-filter-start');
let priceFinish = document.getElementById('input-filter-finish');

priceStart.addEventListener('change', setPriceValues)

priceFinish.addEventListener('change', setPriceValues)

function setPriceValues() {
    let priceStartValue = priceStart.value;
    let priceEndValue = priceFinish.value;
...
// ===== Фильтр от большего к меньшему и наоборот ====================================================================================================================

let arrowPrev = document.querySelector('.arrows-nav__prev');
let arrowNext = document.querySelector('.arrows-nav__next');

arrowPrev.addEventListener('click', () => {
    if (!arrowPrev.classList.contains('active') && !arrowNext.classList.contains('active')) {
        arrowPrev.classList.add('active')
    } else if (!arrowPrev.classList.contains('active') && arrowNext.classList.contains('active')) {
...
// ===== Изменение цвета текста при нажатии ==========================================================================================================================

let navElems = document.querySelectorAll('.item-nav__text');
let navItem = document.querySelector('.item-nav');
...
const designBtn = document.getElementById('design__btn');
...
const filtersCross = document.querySelector('.filters__cross');
